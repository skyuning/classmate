...
abstract class ImitatedAsyncTask<Params, Progress, Result> {
    ...
    public final ImitatedAsyncTask<Params, Progress, Result> execute(Params... params) {
        return executeOnExecutor(sDefaultExecutor, params);
    }

    public final ImitatedAsyncTask<Params, Progress, Result> executeOnExecutor(Executor exec,
            Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final ImitatedAsyncTask mTask;
        final Data[] mData;

        AsyncTaskResult(ImitatedAsyncTask task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
